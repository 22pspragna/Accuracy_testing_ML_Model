...
diabetes_model_path = r"C:\Users\Pragna P S\Documents\workshop-2\3\diabetes.sav"
...
if st.button('Show Model Accuracy'):
    try:
        test_data = pd.read_csv(r"C:\Users\Pragna P S\Documents\workshop-2\3\diabetes.csv")
